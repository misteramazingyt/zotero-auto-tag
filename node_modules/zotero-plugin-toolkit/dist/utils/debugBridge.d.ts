 ...
 */
export declare class DebugBridge {
    static readonly version: number;
    static readonly passwordPref: string;
    get version(): number;
    private _disableDebugBridgePassword;
    get disableDebugBridgePassword(): boolean;
    set disableDebugBridgePassword(value: boolean);
    get password(): string;
    set password(v: string);
    constructor();
    static setModule(instance: ToolkitGlobal): void;
