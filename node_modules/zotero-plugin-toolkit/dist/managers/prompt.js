...
class Prompt {
    ...
    async showSuggestions(inputText) {
        ...
        function $w(e, t, n, i) {
            if (0 === e.length)
                return null;
            for (var r = n.toLowerCase(), o = 0, a = 0, s = [], l = 0; l < e.length; l++) {
                var c = e[l], u = r.indexOf(c, a);
                if (-1 === u)
                    return null;
                var h = n.charAt(u);
                if (u > 0 && !_w.test(h) && !Ww.test(h)) {
                    var p = n.charAt(u - 1);
                    if ((h.toLowerCase() !== h && p.toLowerCase() !== p) ||
    ...
    initInputEvents() {
        this.promptNode.addEventListener("keydown", (event) => {
            if (["ArrowUp", "ArrowDown"].indexOf(event.key) != -1) {
                ...
                commandsContainer.scrollTo(0, commandsContainer.querySelector(".selected")
                    .offsetTop -
    ...
    registerShortcut() {
        this.document.addEventListener("keydown", (event) => {
            if (event.shiftKey && event.key.toLowerCase() == "p") {
                if (event.originalTarget.isContentEditable ||
                ...
                if (this.promptNode.style.display == "none") {
                    ...
                    if (this.promptNode.querySelectorAll(".commands-container").length ==
                        1) {
...
class PromptManager extends basic_2.ManagerTool {
    constructor(base) {
        super(base);
        /**
    ...
    register(commands) {
        // id->name
        commands.forEach((c) => { var _a; return ((_a = c.id) !== null && _a !== void 0 ? _a : (c.id = c.name)); });
