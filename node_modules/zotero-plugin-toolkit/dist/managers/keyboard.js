 ...
 */
class KeyboardManager extends basic_1.ManagerTool {
    constructor(base) {
        super(base);
    ...
    addReaderKeyboardCallback(event) {
        ...
        (0, wait_1.waitUntil)(() => {
            ...
            return !Components.utils.isDeadWrapper(reader._internalReader) &&
                ((_b = (_a = reader._internalReader) === null || _a === void 0 ? void 0 : _a._primaryView) === null || _b === void 0 ? void 0 : _b._iframeWindow);
        }, () => {
            var _a;
