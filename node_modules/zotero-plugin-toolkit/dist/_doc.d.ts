...
import { PreferencePaneManager, PrefPaneOptions } from "./managers/preferencePane";
...
export { BasicTool, ZoteroToolkit, UITool, ElementProps, ReaderTool, ExtraFieldTool, FieldHookManager, ItemTreeManager, ItemBoxManager, KeyboardManager, KeyModifier, LibraryTabPanelManager, ReaderTabPanelManager, ReaderInstanceManager, MenuManager, PreferencePaneManager, PatchHelper, PrefPaneOptions, ShortcutManager, ClipboardHelper, FilePickerHelper, ProgressWindowHelper, VirtualizedTableHelper, DialogHelper, LargePrefHelper, GuideHelper, };
//# sourceMappingURL=_doc.d.ts.map